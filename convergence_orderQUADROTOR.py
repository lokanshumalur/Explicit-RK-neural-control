...
class QuadrotorDynamics:
    ...
    def __call__(self, x, u, t, g=None):
        ...
        T_total = self.mass * self.g + delta_T
...
if __name__ == "__main__":
    ...
    controller = OptimalController(
        ...
        initial_state=x0_quad, hidden_units=hidden_units, activations=activations,
    ...
    step_sizes = np.array([0.05, 0.025, 0.0125, 0.00625, 0.003125])
